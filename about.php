   ...
   <div class="container">
      <div class="row">
         <dir class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
            <div class="about_box">
               <figure><img src="images/arsitektur2.jpg"/></figure>
            </div>
         </dir>
          <dir class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
            <div class="about_box">
               <h3>YourArchi.id</h3>
               <p>Website yang menjual jasa bidang desain arsitektur bangunan, baik eksterior atau interior. Web ini dapat mempertemukan orang yang memiliki passion bidang desain bangunan dan orang yang membutuhkan jasa desain bangunan</p>
               <p>Pada website ini terdapat dua jenis user yaitu Desainer dan juga Customer. Desainer akan menjual desainnya melalui website ini. Sedangkan Customer yaitu orang yang mencari desain bisa memesan desain melalui website ini.</p>
            </div>
         </dir> 
      </div>
   </div>
