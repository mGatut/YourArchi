         ...
         <div class="container">
            <div class="row">
                     ...
                     <div class="limit-box">
                        <nav class="main-menu">
                           <ul class="menu-area-main">
                              ...
                              <li> <a href="product.html">design</a> </li>
                              <li> <a href="blog.html"> Blog</a> </li>
                              <!-- <li> <a href="contact.html">Contact</a> </li> -->
                              <li class="mean-last"> <a href="contact.html">signup</a> </li>
               ...
               <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                  <li><a class="buy" href="contact.html">Login</a></li>
               </div>
            </div>
         </div>
         <!-- end header inner --> 
               ...
               <div class="carousel-item active">
                  ...
                  <div class="container">
                     <div class="carousel-caption relative">
                        ...
                        <a  href="product.html">see more Design</a>
                     </div>
                  </div>
               </div>
