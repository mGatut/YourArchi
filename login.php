                ...
                <div class="col-md-12">
                    ...
                    <form class="main_form">
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <input class="form-control" placeholder="Password" type="text" name="Password" required autofocus>
                            </div>
                            <div class=" col-md-12">
                                <input class="form-control" placeholder="Tipe User" type="text" name="Tipe User" required autofocus>
                            </div>
                            <div class=" col-md-12">
