               ...
               <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                  <div class="full">
                     <div class="center-desk">
                        <div class="logo"> <a href="index.php"><img src="images/logo.jpeg" alt="logo"/></a> </div>
                     </div>
                  </div>
               </div>
                     ...
                     <div class="limit-box">
                        <nav class="main-menu">
                           <ul class="menu-area-main">
                              ...
                              <li> <a href="desain.php">Design</a> </li>
                              <li> <a href="desainer.php">Designer</a> </li>
         ...
         <div id="main_slider" class="carousel slide banner-main" data-ride="carousel">
            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  ...
                  <div class="container">
                     <div class="carousel-caption relative">
                        <h1> <br> <strong class="black_bold">Latest </strong><br>
                           <strong class="yellow_bold">Design </strong></h1>
                        <a  href="desain.php">see more Design</a>
                     </div>
                  </div>
               </div>
               <div class="carousel-item">
                  ...
                  <div class="container">
                     <div class="carousel-caption relative">
                        <h1><br> <strong class="black_bold">Best </strong><br>
                           <strong class="yellow_bold">Design </strong></h1>
                        <a  href="desain.php">see more Design</a>
                     </div>
                  </div>
            ...
            <div class="row">
               <div class="col-md-7 offset-md-3">
                  <div class="title">
                     ...
                     <span>We have best design and best designer!</span>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="choose_bg">
         <div class="container">
            ...
            <div class="row">
               ...
               <div class="col-md-12">
                  <a href="desainer.php" class="read-more">Read More</a>
               </div>
            </div>
         </div>
       </div>
      ...
      <div class="product">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="title">
                     <h2>our <strong class="black">design</strong></h2>
                     <span>We package the design with best services to make you a happy customer.</span>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="row">
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><img src="images/desain7.jpeg"/></i>
                     <h3>Design A</h3>
                     <!-- <span>Rp..</span> -->
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><img src="images/desain12.jpeg"/></i>
                     <h3>Design B</h3>
                     <!-- <span>Rp..</span> -->
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><img src="images/desain2.jpeg"/></i>
                     <h3>Design C</h3>
                     <!-- <span>Rp..</span> -->
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><img src="images/desain1.jpeg"/></i>
                     <h3>Design D</h3>
                     <!-- <span>Rp..</span> -->
                  </div>
               </div>
               <div class="col-md-12">
                  <a href="desain.php" class="read-more">Read More</a>
               </div>
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            <div class="container">
              <div class="carousel-caption text-bg">
                <div class="">
                  <i><img src="images/lllll.png"/><span>Jane Gea<br><strong class="date">27/12/2019</strong></span></i>
                  
               </div>
                <p>Desainernya profesional banget!<br>
                </p>
